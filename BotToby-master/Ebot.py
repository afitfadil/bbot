...
Bots=[mid,Amid,Bmid,Cmid,"uee108ba95fb11fa9b7ff4c2146f91846"]
admin=["uee108ba95fb11fa9b7ff4c2146f91846"]
creator=["uee108ba95fb11fa9b7ff4c2146f91846"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u1cfa78f51b73b530febc4fa98087a2ba"}
					cl.sendMessage(msg)
#-----------------------------------------------
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Kadir bous")
                                        kk.sendText(msg.to,"Kadir bous")
                                        kc.sendText(msg.to,"Kadir bous")
#-----------------------------------------------
...
#---------CCTV-----------
        ...
        if op.type == 17:
           ...
           cl.sendText(op.param1,"Budayakan Baca Note !!! yah Ka 馃槉\nSemoga Betah Kk 馃槝")
           print "MEMBER HAS JOIN THE GROUP"

        if op.type == 15:
           if op.param2 in Bots:
              return
           cl.sendText(op.param1, "Good Bye Kaka")
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == True:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by @BanaspatI")
